...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "  aw agents [--server ...] [--account ...]")
	fmt.Fprintln(os.Stderr, "  aw project [--server ...] [--account ...]")
	...
	fmt.Fprintln(os.Stderr, "  aw chat send [options] <alias> <message>")
	...
	fmt.Fprintln(os.Stderr, "  aw lock revoke [--server ...] [--account ...] [--prefix ...]")
	fmt.Fprintln(os.Stderr, "  aw lock list [--prefix ...]")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Chat send options: --wait N, --start-conversation, --leave-conversation, --server, --account")
	fmt.Fprintln(os.Stderr, "Flags must come BEFORE positional <args> (e.g. aw chat send --wait 5 bob \"hello\")")
	fmt.Fprintln(os.Stderr, "")
...
func runChatSend(args []string) {
	...
	positional := fs.Args()
	if len(positional) != 2 {
		fmt.Fprintln(os.Stderr, "usage: aw chat send [options] <alias> <message>")
		fmt.Fprintln(os.Stderr, "  options: --wait N, --start-conversation, --leave-conversation, --server, --account")
		fmt.Fprintln(os.Stderr, "  flags must come BEFORE positional args")
		os.Exit(2)
	}
